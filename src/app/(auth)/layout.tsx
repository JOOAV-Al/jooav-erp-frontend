...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex bg-background overflow-y-auto">
          ...
          <p className="mt-5 text-center text-xs text-muted-foreground leading-relaxed w-full px-1">
            {isRegister ? (
              <>
                ...
                <Link href="/terms" className="text-heading underline font-medium">
                  Terms
                </Link>{" "}
                and{" "}
                <Link href="/terms" className="text-heading underline font-medium">
      ...
      {/* ─────────────────────────────── RIGHT PANEL ────────────────────────────── */}
      <div 
        className="hidden lg:flex flex-1 flex-col relative overflow-hidden bg-gradient-to-b from-blue-100 to-transparent"
      >
        ...
        <div className="p-8">
          <div 
            className="flex items-center justify-between rounded-xl bg-nominal-background p-main h-pill text-sm shadow-card border-b-2 border-blue-100 max-w-[500px] mx-auto"
          >
