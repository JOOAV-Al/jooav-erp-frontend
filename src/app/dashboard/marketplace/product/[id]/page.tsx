...
//   const handleBuyNow = () => {
//     //Adds the item to the users draft cart and proceed to the checkout page with the product added to the card
//   };
...
"use client";
import ProductDetailsPageComponent from "@/features/marketplace/components/ProductDetailsPageComponent";
